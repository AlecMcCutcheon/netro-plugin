 ...
 * Set by station detector (ROUTE); cleared when ENTRY fires at that node/terminal.
 */
public class StationController {
    ...
    public StationController(String id, String stationId, String targetNodeId, String world, int x, int y, int z,
